          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5">
              <div className="relative">
                <div className="absolute -inset-3 rounded-[28px] bg-gradient-to-br from-[#B8C9B0]/60 to-[#7E9568]/40 blur-xl" />
                <div className="relative rounded-[24px] bg-white border border-[#E7EEDF] p-6 md:p-8 shadow-[0_30px_80px_-30px_rgba(74,93,67,0.35)]">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="w-2.5 h-2.5 rounded-full bg-[#E7B8B8]" />
                      <span className="w-2.5 h-2.5 rounded-full bg-[#E7DDB8]" />
                      <span className="w-2.5 h-2.5 rounded-full bg-[#9CAF88]" />
                    </div>
                    <span className="text-[11px] tracking-wider uppercase text-[#607851]">Now playing</span>
                  </div>
                  <div className="mt-6">
                    <p className="text-xs uppercase tracking-[0.22em] text-[#607851]">Currently building</p>
                    <h3 className="mt-2 font-serif text-2xl md:text-3xl text-[#2C3A2A] leading-tight">
                      A wellness studio booking platform with calm, accessible UI.
                    </h3>
                  </div>
                  <div className="mt-6 grid grid-cols-3 gap-3">
                    {['React', 'FastAPI', 'Mongo'].map((t) => (
                      <div key={t} className="rounded-xl border border-[#E7EEDF] bg-[#FAF8F3] py-3 text-center text-sm text-[#4A5D43]">
                        {t}
                      </div>
                    ))}
                  </div>
                  <div className="mt-6 h-1.5 w-full bg-[#E7EEDF] rounded-full overflow-hidden">
                    <div className="h-full w-[68%] bg-gradient-to-r from-[#9CAF88] to-[#4A5D43] rounded-full" />
                  </div>
                  <div className="mt-2 flex items-center justify-between text-xs text-[#4A5D43]/70">
                    <span>Phase 3 / 5</span>
                    <span>Beta in 2 weeks</span>
                  </div>
                </div>

                <div className="absolute -bottom-6 -left-6 rounded-2xl bg-[#2C3A2A] text-[#E7EEDF] px-5 py-4 shadow-xl">
                  <p className="text-[10px] uppercase tracking-[0.22em] text-[#9CAF88]">Open for</p>
                  <p className="font-serif text-base mt-0.5">Q3 collaborations</p>
                </div>
              </div>
            </div>
          </div>
